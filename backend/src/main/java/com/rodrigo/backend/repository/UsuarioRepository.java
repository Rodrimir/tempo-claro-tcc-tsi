...
public class UsuarioRepository {
        ...
        // @audit-ok [Cadastro(3) — repository de autenticação: INSERT com todos os campos do usuário incluindo hash da senha]
        ...
        // @audit-ok [Profile(3) — repository de perfil: atualiza campos editáveis do usuário exceto criado_em: PUT /api/profile]
        ...
        // @audit-ok [Excluir Conta(3) — repository de perfil: DELETE por id; ON DELETE CASCADE no schema remove os dados dependentes do usuário]
