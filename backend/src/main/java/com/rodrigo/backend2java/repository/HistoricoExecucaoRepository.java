...
public class HistoricoExecucaoRepository {
    ...
    // @audit-ok [Execução Timer (21) — COUNT por execution_token; retorna true se já foi processado (idempotência)]
    ...
    // @audit-ok [Execução Timer (25) — INSERT no histórico com tipo_sucesso, valor_realizado e moedas_ganhas]
