// @audit-ok: BACKEND-BibliotecaTextoRepository.java-01
...
public class BibliotecaTextoRepository {
    ...
    private static final String FIND_BY_CATEGORIA_AND_IDIOMA = 
            "SELECT * FROM biblioteca_textos WHERE categoria = ? AND idioma = ?";
