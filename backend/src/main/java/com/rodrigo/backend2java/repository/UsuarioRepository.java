// @audit-ok: BACKEND-UsuarioRepository.java-01
...
public class UsuarioRepository {
    ...
    private static final String INSERT_USUARIO = 
            "INSERT INTO usuarios (id, nome, email, senha_hash, fuso_horario, preferencia_idioma, criado_em) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?)";
            
    private static final String UPDATE_USUARIO = 
            "UPDATE usuarios SET nome = ?, email = ?, senha_hash = ?, fuso_horario = ?, preferencia_idioma = ? WHERE id = ?";
