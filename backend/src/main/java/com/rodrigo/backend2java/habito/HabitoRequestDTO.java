...
public record HabitoRequestDTO(
        ...
        /**
         * Aceito e ignorado. A coluna {@code hab_modalidade} saiu do schema na v3.0
         * — não tinha origem em nenhum RF/F/UC e nenhuma regra ramificava sobre ela
         * (o próprio schema a marcava como "propósito não confirmado"). O componente
         * fica aqui porque {@code fail-on-unknown-properties} está ligado: removê-lo
         * faria o app publicado receber 400 ao criar hábito. Sai quando os clientes
         * pararem de enviá-lo.
         */
        ...
        /**
         * Quando o hábito nasceu de uma calibração aceita (RF20), o id devolvido por
         * {@code POST /api/calibration}. Marca a sugestão como aceita e a liga ao
         * hábito — é o que permite, depois, comparar o que foi sugerido com o que a
         * pessoa de fato manteve. Opcional: o preenchimento manual continua sendo um
         * caminho completo.
         */
        UUID calibracao_id) {
